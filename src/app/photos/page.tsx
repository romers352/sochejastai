...
export default function PhotosPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <h1 className="text-3xl font-bold text-[#ff914d] mb-2">Photo Gallery</h1>
      <p className="text-[#ff914d]/80 mb-6">Browse our latest photos, curated to inspire.</p>
      <section aria-labelledby="photos-grid-heading">
        <h2 id="photos-grid-heading" className="sr-only">Photo Items</h2>
        ...
        {items.map((p) => (
          ...
          >
            ...
            <img src={p.src} alt={p.title} className="h-40 w-full object-cover group-hover:scale-105 transition-transform" />
            ...
            <span className="absolute bottom-2 left-2 text-[#ff914d] text-sm">{p.title}</span>
          </button>
        ))}
        </div>
      </section>
