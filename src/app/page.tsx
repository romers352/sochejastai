                  ...
                  return (
                    <div className="h-full w-full relative text-[#ff914d] flex items-center justify-center">
                      ...
                      <div className="absolute inset-0 hidden md:block" aria-hidden>
                        ...
                        <div
                          className={`absolute inset-0 ${wideUrl ? "bg-center bg-cover" : classFallback} blur-2xl brightness-75 transition-transform duration-700`}
                      ...
                      <div className="absolute inset-0 block md:hidden" aria-hidden>
                        <div className="absolute inset-0 bg-gradient-to-br from-[#0b254a] via-[#0a1f3e] to-[#081833]" />
                        <div
                          className={`absolute inset-0 ${squareUrl ? "bg-center bg-cover" : classFallback} blur-2xl brightness-75 transition-transform duration-700`}
